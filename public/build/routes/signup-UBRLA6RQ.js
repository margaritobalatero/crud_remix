...
function Signup() {
  ...
  return /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("div", { className: "max-w-md mx-auto mt-12 p-6 bg-white shadow-md rounded-lg", children: [
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("h1", { className: "text-2xl font-bold mb-4", children: "Signup" }, void 0, false, {
    ...
    /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)(Form, { method: "post", className: "flex flex-col gap-3", children: [
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("input", { type: "text", name: "username", placeholder: "Username", required: true, className: "border rounded px-3 py-2" }, void 0, false, {
        fileName: "app/routes/signup.tsx",
        lineNumber: 74,
        columnNumber: 9
      }, this),
      ...
      /* @__PURE__ */ (0, import_jsx_dev_runtime.jsxDEV)("button", { type: "submit", className: "bg-green-600 text-white rounded px-4 py-2 hover:bg-green-700", children: "Signup" }, void 0, false, {
        fileName: "app/routes/signup.tsx",
        lineNumber: 77,
        columnNumber: 9
      }, this)
